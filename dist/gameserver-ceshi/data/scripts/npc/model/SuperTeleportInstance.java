 ...
 * NPC輔助
 **/
public class SuperTeleportInstance extends NpcInstance
{

	public SuperTeleportInstance(int objectId, NpcTemplate template, MultiValueSet<String> set)
	{
	...
	private boolean checkUseCondition(Player player)
	{
		 ...
		 {
			 //紅人不能傳送
			String html = HtmCache.getInstance().getHtml("teleporter/40001-teleports-pk.htm", player);

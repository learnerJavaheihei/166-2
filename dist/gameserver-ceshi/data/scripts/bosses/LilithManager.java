...
public class LilithManager extends SevenSignsRaidManager implements OnInitScriptListener
{
	...
	private static final SchedulingPattern REUSE_PATTERN = new SchedulingPattern("0 21 * * 5"); // 重生時間（每週二和五的21:00）

	// Dungeon Parameters
	//下面坐標改成你要刷的點進去就可以直接挑戰首領
	private static final Location DUNGEON_ENTER_LOCATION = new Location(185059, -9610, -5400); // Точка входа в логово
	...
	private static final Location RAID_ENTER_LOCATION = new Location(185656, -10136, -5400);	// Точка входа к рейду
	...
	private static final int GATEKEEPER_ZIGGURAT = 31089;	//	Хранитель Портала Зиккурат

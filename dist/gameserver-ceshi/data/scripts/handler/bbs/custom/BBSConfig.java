...
public class BBSConfig implements OnLoadScriptListener
{
	...
	//增加 自定義NPC輔助收費--
	public static int BUFF_SERVICE_NPC_COST_ITEM_ID;
	public static long BUFF_SERVICE_NPC_COST_ITEM_COUNT;
	public static boolean BUFF_SERVICE_NPC_COST_FOR_PREMIUM_FREE;
	public static int BUFF_SERVICE_NPC_MAX_LEVEL_FOR_FREE_BUFF;
	//--增加 自定義NPC輔助收費
	...
	public static boolean TELEPORT_SERVICE_TELEPORT_IF_PVP;//增加 佈告欄紫名傳送限制
	...
	public static int HERO_SERVICE_COST_ITEM_ID_PER_FOREVER;
	public static long HERO_SERVICE_COST_ITEM_COUNT_PER_FOREVER;
	...
	public static boolean ALLOW_DROP_CALCULATOR;//增加config佈告欄搜尋啟動
	...
	public void onLoad()
	{
		...
		ALLOW_DROP_CALCULATOR = properties.getProperty("ALLOW_DROP_CALCULATOR", false);//增加config佈告欄搜尋啟動
		...
		//增加 自定義NPC輔助收費--
		BUFF_SERVICE_NPC_COST_ITEM_ID = properties.getProperty("BUFF_SERVICE_NPC_COST_ITEM_ID", 57);
		BUFF_SERVICE_NPC_COST_ITEM_COUNT = properties.getProperty("BUFF_SERVICE_NPC_COST_ITEM_COUNT", 1000L);
		BUFF_SERVICE_NPC_COST_FOR_PREMIUM_FREE = properties.getProperty("BUFF_SERVICE_NPC_COST_FOR_PREMIUM_FREE", true);
		BUFF_SERVICE_NPC_MAX_LEVEL_FOR_FREE_BUFF = properties.getProperty("BUFF_SERVICE_NPC_MAX_LEVEL_FOR_FREE_BUFF", 86);
		//--增加 自定義NPC輔助收費
		...
		TELEPORT_SERVICE_TELEPORT_IF_PVP = properties.getProperty("TELEPORT_SERVICE_TELEPORT_IF_PVP", false);//增加 佈告欄紫名傳送限制
		...
		// Hero purchase service
		HERO_SERVICE_COST_ITEM_ID_PER_1_DAY = properties.getProperty("HERO_SERVICE_COST_ITEM_ID_PER_1_DAY", 0);
		HERO_SERVICE_COST_ITEM_COUNT_PER_1_DAY = properties.getProperty("HERO_SERVICE_COST_ITEM_COUNT_PER_1_DAY", 100000000L);
		HERO_SERVICE_PERIOD_VARIATIONS = properties.getProperty("HERO_SERVICE_PERIOD_VARIATIONS", new int[]{ 1 }, ",");
		HERO_SERVICE_COST_ITEM_ID_PER_FOREVER = properties.getProperty("HERO_SERVICE_COST_ITEM_ID_PER_FOREVER", 0);
		HERO_SERVICE_COST_ITEM_COUNT_PER_FOREVER = properties.getProperty("HERO_SERVICE_COST_ITEM_COUNT_PER_FOREVER", 10000000000L);
		...
		{
			if(grade != grade.extGrade()) // Берем только основные грейды.
				continue;

			final int weaponMaxEnchantLevel = properties.getProperty("ENCHANT_SERVICE_" + grade + "_WEAPON_MAX_ENCHANT_LEVEL", grade == ItemGrade.NONE ? 0 : 16);
			...
			final int armorMaxEnchantLevel = properties.getProperty("ENCHANT_SERVICE_" + grade + "_ARMOR_MAX_ENCHANT_LEVEL", grade == ItemGrade.NONE ? 0 : 16);
			...
			final int jewelryMaxEnchantLevel = properties.getProperty("ENCHANT_SERVICE_" + grade + "_JEWELRY_MAX_ENCHANT_LEVEL", grade == ItemGrade.NONE ? 0 : 16);

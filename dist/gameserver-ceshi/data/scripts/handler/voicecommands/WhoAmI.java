...
public class WhoAmI extends ScriptVoiceCommandHandler
{
	...
	public boolean useVoicedCommand(String command, Player player, String args)
	{
		...
		double hpDrain = player.getStat().calc(Stats.ABSORB_DAMAGE_PERCENT, 0., target, null);
		double mpDrain = player.getStat().calc(Stats.ABSORB_DAMAGEMP_PERCENT, 0., target, null);
		...
		sb.replaceFirst("%bleedPower%", bleedPower == Double.POSITIVE_INFINITY ? (player.isLangRus() ? "無敵" : "无敌") : df.format(bleedPower));
		sb.replaceFirst("%bleedResist%", bleedResist == Double.POSITIVE_INFINITY ? (player.isLangRus() ? "無敵" : "无敌") : df.format(bleedResist));
		sb.replaceFirst("%poisonPower%", poisonPower == Double.POSITIVE_INFINITY ? (player.isLangRus() ? "無敵" : "无敌") : df.format(poisonPower));
		sb.replaceFirst("%poisonResist%", poisonResist == Double.POSITIVE_INFINITY ? (player.isLangRus() ? "無敵" : "无敌") : df.format(poisonResist));
		sb.replaceFirst("%stunPower%", stunPower == Double.POSITIVE_INFINITY ? (player.isLangRus() ? "無敵" : "无敌") : df.format(stunPower));
		sb.replaceFirst("%stunResist%", stunResist == Double.POSITIVE_INFINITY ? (player.isLangRus() ? "無敵" : "无敌") : df.format(stunResist));
		sb.replaceFirst("%rootPower%", rootPower == Double.POSITIVE_INFINITY ? (player.isLangRus() ? "無敵" : "无敌") : df.format(rootPower));
		sb.replaceFirst("%rootResist%", rootResist == Double.POSITIVE_INFINITY ? (player.isLangRus() ? "無敵" : "无敌") : df.format(rootResist));
		sb.replaceFirst("%sleepPower%", sleepPower == Double.POSITIVE_INFINITY ? (player.isLangRus() ? "無敵" : "无敌") : df.format(sleepPower));
		sb.replaceFirst("%sleepResist%", sleepResist == Double.POSITIVE_INFINITY ? (player.isLangRus() ? "無敵" : "无敌") : df.format(sleepResist));
		sb.replaceFirst("%paralyzePower%", paralyzePower == Double.POSITIVE_INFINITY ? (player.isLangRus() ? "無敵" : "无敌") : df.format(paralyzePower));
		sb.replaceFirst("%paralyzeResist%", paralyzeResist == Double.POSITIVE_INFINITY ? (player.isLangRus() ? "無敵" : "无敌") : df.format(paralyzeResist));
		sb.replaceFirst("%mentalPower%", mentalPower == Double.POSITIVE_INFINITY ? (player.isLangRus() ? "無敵" : "无敌") : df.format(mentalPower));
		sb.replaceFirst("%mentalResist%", mentalResist == Double.POSITIVE_INFINITY ? (player.isLangRus() ? "無敵" : "无敌") : df.format(mentalResist));
		...
		sb.replaceFirst("%swordResist%", swordResist == Double.POSITIVE_INFINITY ? (player.isLangRus() ? "無敵" : "无敌") : df.format(swordResist));
		sb.replaceFirst("%dualResist%", dualResist == Double.POSITIVE_INFINITY ? (player.isLangRus() ? "無敵" : "无敌") : df.format(dualResist));
		sb.replaceFirst("%bluntResist%", bluntResist == Double.POSITIVE_INFINITY ? (player.isLangRus() ? "無敵" : "无敌") : df.format(bluntResist));
		sb.replaceFirst("%daggerResist%", daggerResist == Double.POSITIVE_INFINITY ? (player.isLangRus() ? "無敵" : "无敌") : df.format(daggerResist));
		sb.replaceFirst("%bowResist%", bowResist == Double.POSITIVE_INFINITY ? (player.isLangRus() ? "無敵" : "无敌") : df.format(bowResist));
		sb.replaceFirst("%crossbowResist%", crossbowResist == Double.POSITIVE_INFINITY ? (player.isLangRus() ? "無敵" : "无敌") : df.format(crossbowResist));
		sb.replaceFirst("%twoHandCrossbowResist%", twoHandCrossbowResist == Double.POSITIVE_INFINITY ? (player.isLangRus() ? "無敵" : "无敌") : df.format(twoHandCrossbowResist));
		sb.replaceFirst("%fistResist%", fistResist == Double.POSITIVE_INFINITY ? (player.isLangRus() ? "無敵" : "无敌") : df.format(fistResist));
		sb.replaceFirst("%poleResist%", poleResist == Double.POSITIVE_INFINITY ? (player.isLangRus() ? "無敵" : "无敌") : df.format(poleResist));

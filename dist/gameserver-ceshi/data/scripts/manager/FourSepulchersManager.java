...
public class FourSepulchersManager implements OnDeathListener
{
	...
	private static class ChangeEntryTime implements Runnable
	{
		@Override
		public void run()
		{
	...
	private static class ChangeWarmUpTime implements Runnable
	{
		@Override
		public void run()
		{
	...
	private static class ChangeAttackTime implements Runnable
	{
		@Override
		public void run()
		{
			...
			{
				NpcInstance npc = NpcUtils.spawnSingle(gk.template.getId(), gk);
	...
	private static class ChangeCoolDownTime implements Runnable
	{
		@Override
		public void run()
		{
			...
			LOGGER.info("四大陵墓管理：入場時間: " + TimeUtils.toSimpleFormat(time.getTimeInMillis()));
			if(_firstTimeRun)

...
{
	private static final int PATHFINDER = 32485;//開拓者幹員 覺醒
	...
	public void startPathfinderTimer(long timeInMillis)
	{
		...
		_expireTask = ThreadPoolManager.getInstance().schedule(() ->
		{
			try
			{
				...
				if(p != null)
				{
					...
					if(iz != null)
					{
						...
						if(loc != null)
						{
							NpcUtils.spawnSingle(PATHFINDER, Location.parseLoc(loc), KamalokaNightmare.this);
						}
					}
				}
				else

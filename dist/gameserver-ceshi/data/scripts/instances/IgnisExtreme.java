 ...
 * @author Bonux
 */
public class IgnisExtreme extends Reflection
{
	private final int RAID_NPC_ID = 29120;	// Баюм
	private final int Freya_NPC_ID = 29124;	// Баюм
	...
	private NpcInstance RFreya_NPC ;
	//55256, 219096, -3232
	private static Location RAIDSpawn = new Location(202344, 170328, -15488);
	private static Location FreyaSpawn = new Location(203784, 169128, -15488);
	//clearReflection 
	@Override
	...
	private class Spawn implements Runnable
	{
		...
		public void run()
		{
			...
			RFreya_NPC = addSpawnWithoutRespawn(Freya_NPC_ID, FreyaSpawn, 0);
		}
	}

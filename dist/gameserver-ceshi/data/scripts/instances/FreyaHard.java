...
public class FreyaHard extends Reflection
{
	...
	private static final int FreyaStandHard = 29180;//芙蕾雅 冰雪女王 覺醒
	private static final int IceKnightHard = 18856; //冰宮騎士 覺醒
	private static final int IceKnightLeaderHard = 25700;//格拉奇恩斯 冰宮騎士團長 覺醒
	...
	private class StartHardFreya implements Runnable
	{
		@Override
		public void run()
		{
	...
	private class PreStage implements Runnable
	{
		...
		public void run() 
		{
			...
			//spawning few guards
			for(int i = 0; i < 15; i++)
				addSpawnWithoutRespawn(IceKnightHard, Territory.getRandomLoc(centralRoom, getGeoIndex(),false), 0);
	...
	private class PreSecondStage implements Runnable
	{
		...
		public void run()
		{
			...
			ThreadPoolManager.getInstance().schedule(new TimerToSecondStage(), 1000L); // 22.1 secs for movie
		}
	}
	...
	private class KnightCaptainSpawnMovie implements Runnable
	{
		...
		public void run()
		{
			...
			ThreadPoolManager.getInstance().schedule(new KnightCaptainSpawn(), 1000L);
		}
	}
	...
	private class PreThirdStageM implements Runnable
	{
		...
		public void run()
		{
			...
			ThreadPoolManager.getInstance().schedule(new ThirdStage(), 1000L); // 21.5 secs for movie
		}
	}
	...
	private class PreForthStage implements Runnable
	{
		...
		public void run()
		{
			...
			//}
			ThreadPoolManager.getInstance().schedule(new ForthStage(), 5000L); // 27 secs for movie
		}
	}
	...
	private class ConclusionMovie implements Runnable
	{
		...
		public void run()
		{
			...
			ThreadPoolManager.getInstance().schedule(new InstanceConclusion(), 3000L); // 56 secs for movie
		}
	}

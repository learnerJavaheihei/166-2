...
{
	private static final int small_baby_gourd = 13399;	// 未成熟的積雪葫蘆
	private static final int g_small_adult_gourd = 13400;	// 優良的積雪葫蘆
	private static final int b_small_adult_gourd = 13401;	// 不良的積雪葫蘆
	private static final int big_baby_gourd = 13403;	// 未成熟的積雪大葫蘆
	private static final int g_big_adult_gourd = 13404;	// 優良的積雪大葫蘆
	private static final int b_big_adult_gourd = 13405;	// 不良的積雪大葫蘆
	private static final int kg_small_adult_gourd = 13402;	// 優良的積雪葫蘆王
	private static final int kg_big_adult_gourd = 13406;	// 優良的積雪大葫蘆王

	private static final int s_gourd_nectar = 17110;	// 雪葫蘆神酒
		...
		if(killer != null && actor.getDistance(killer) <= 1500)
		{
			...
			else if(npcId == kg_big_adult_gourd) // Королевская Большая Спелая Тыква 
			{
				...
				if(Rnd.chance(5))
				{
					...
					{
						if(Rnd.chance(5))
							actor.dropItem(actor.getPlayer(), 6569, 1);	// Благословенный Свиток: Модифицировать Оружие (A)
						else if(Rnd.chance(10))
							actor.dropItem(actor.getPlayer(), 49756, 1);	// Лоскут Ткани
						else if(Rnd.chance(20))
							actor.dropItem(actor.getPlayer(), 90020, 1);	// Сундук с Лучшей Краской 3-я профессия

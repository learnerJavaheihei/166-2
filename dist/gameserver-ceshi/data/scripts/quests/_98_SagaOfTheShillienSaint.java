...
public class _98_SagaOfTheShillienSaint extends Quest {
    ...
    public final int AIKEN = 31581;//анастия
    public final int JER = 30657;//сересин
    public final int RIFKEN = 34268;//рифкен
    public final int BELINDA = 30476;//кайра
    ...
    public final int TENBELEFA = 27274;//3 моб танакиа
    public final int KAIN = 31621;// элькардия
    ...
    public final int OSKOLOK_KRI_HOLODA = 49832;
    public final int ZNAK_HALIWI = 7513;
    ...
    public _98_SagaOfTheShillienSaint() {
        ...
        addClassIdCheck("aiken03.htm", 43);
    }
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("aiken02a.htm")) {
            ...
            if (st.getCond() == 18) {
                ...
                player.setClassId(ClassId.SHILLIEN_SAINT.getId(), false);
                if (player.getBaseClassId() == ClassId.SHILLEN_ELDER.getId())
                    player.setClassId(ClassId.SHILLIEN_SAINT.getId(), false);
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == AIKEN) {
            if (cond == 0) {
                if (st.getPlayer().getLevel() >= 76 && st.getPlayer().getClassId().getId() == 43)

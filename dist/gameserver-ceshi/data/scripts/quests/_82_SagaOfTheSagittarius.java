...
public class _82_SagaOfTheSagittarius extends Quest {
    ...
    public final int AIKEN = 30702;//bern
    public final int JER = 31604;//grim
    public final int RIFKEN = 34270;//broom
    public final int FELIX = 31641;//palo	
    ...
    public final int BLUSTITEL = 27214;   //1
    public final int AIRON = 27296; //2
    public final int ARHONT_HALIWI = 27219;
    public final int TENBELEFA = 27302;//3
    public final int KAIN = 31633;//4
    ...
    public final int OSKOLOK_KRI_HOLODA = 49816;
    public final int ZNAK_HALIWI = 7497;
    ...
    public _82_SagaOfTheSagittarius() {
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("aiken02a.htm")) {
            ...
            if (st.getCond() == 18) {
                ...
                player.setClassId(ClassId.SAGITTARIUS.getId(), false);
                if (player.getBaseClassId() == ClassId.HAWKEYE.getId())
                    player.setClassId(ClassId.SAGITTARIUS.getId(), false);
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == AIKEN) {
            if (cond == 0) {
                if (st.getPlayer().getLevel() >= 76 && st.getPlayer().getClassId().getId() == 9)

...
{
	public final int GAROM = 34021;			//卡崙
	public final int SUNDUK = 24058;		//華麗寶箱
	public final int TELEPORT1 = 34038;		//移動裝置
	
	//mobs
	public final int PLAKALWIK = 24041;		//血腥哭泣者
	public final int DOHLAK = 24042;		//躡行無能者
	public final int SYWESTVO = 24043;		//腐敗者
		
		
	//items
	public final int KEY = 90815;			//海盜的寶箱鑰匙
	public final int NAGRADASUNDUK = 90762;	//海盜的寶箱
	public final int MAP = 90756;			//海盜的藏寶圖
	public final int PIECEMAP = 90755;		//海盜的藏寶圖碎片

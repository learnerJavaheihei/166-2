...
public class _79_SagaOfTheAdventurer extends Quest {
    ...
    public final int AIKEN = 31603;
    public final int JER = 34266;
    public final int RIFKEN = 34269;
    public final int FELIX = 31616;
    ...
    public final int OSKOLOK_KRI_HOLODA = 49813;
    public final int ZNAK_HALIWI = 7494;
    ...
    public _79_SagaOfTheAdventurer() {
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("aiken02a.htm")) {
            ...
            if (st.getCond() == 18) {
                ...
                player.setClassId(ClassId.ADVENTURER.getId(), false);
                if (player.getBaseClassId() == ClassId.TREASURE_HUNTER.getId())
                    player.setClassId(ClassId.ADVENTURER.getId(), false);
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == AIKEN) {
            if (cond == 0) {
                if (st.getPlayer().getLevel() >= 76 && st.getPlayer().getClassId().getId() == 8)

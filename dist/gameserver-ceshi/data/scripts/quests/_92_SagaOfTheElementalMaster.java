...
public class _92_SagaOfTheElementalMaster extends Quest {
    ...
    public final int AIKEN = 30174;//аркениас
    public final int JER = 31614;//радис
    public final int RIFKEN = 31281;//керенас
    ...
    public final int AIRON = 27313; //2 шакиель
    public final int ARHONT_HALIWI = 27219;
    public final int TENBELEFA = 27311;//3 келвас
    public final int KAIN = 31629;//4 калейдос
    ...
    public final int OSKOLOK_KRI_HOLODA = 49826;
    public final int ZNAK_HALIWI = 7507;
    ...
    public _92_SagaOfTheElementalMaster() {
        ...
        addKillNpcWithLog(9, B_LIST, 1, 27313);//2
        addKillNpcWithLog(13, C_LIST, 1, ARHONT_HALIWI);
        addKillNpcWithLog(16, D_LIST, 1, 27311);//3
        ...
        addClassIdCheck("aiken03.htm", 28);
    }
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("aiken02a.htm")) {
            ...
            if (st.getCond() == 18) {
                ...
                player.setClassId(ClassId.ELEMENTAL_MASTER.getId(), false);
                if (player.getBaseClassId() == ClassId.ELEMENTAL_SUMMONER.getId())
                    player.setClassId(ClassId.ELEMENTAL_MASTER.getId(), false);
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == AIKEN) {
            if (cond == 0) {
                if (st.getPlayer().getLevel() >= 76 && st.getPlayer().getClassId().getId() == 28)

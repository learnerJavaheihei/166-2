...
public class _73_SagaOfTheDuelist extends Quest {
    ...
    public final int ATHEBALT = 30691;
    ...
    public final int BLUSTITEL = 27216;
    public final int AIRON = 27289;
    public final int ARHONT_HALIWI = 27219;
    public final int TENBELEFA = 27281;
    public final int KAIN = 31639;
    ...
    public final int OSKOLOK_KRI_HOLODA = 49807;
    public final int ZNAK_HALIWI = 7488;
    ...
    public _73_SagaOfTheDuelist() {
        ...
        addKillNpcWithLog(7, A_LIST, 20, 27216);
        addKillNpcWithLog(9, B_LIST, 1, 27289);
        addKillNpcWithLog(13, C_LIST, 1, ARHONT_HALIWI);
        addKillNpcWithLog(16, D_LIST, 1, 27281);
        ...
        addLevelCheck("sedrik_q73_02.htm", 76);
        addClassIdCheck("sedrik_q73_03.htm", 2);
    }

    @Override
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        String htmltext = event;
        if (event.equalsIgnoreCase("sedrik_q73_02a.htm")) {
            htmltext = "sedrik_q73_5.htm";
        } else if (event.equalsIgnoreCase("sedrik_q73_01s.htm")) {
            if (st.getCond() == 0)
                st.setCond(1);
        } else if (event.equalsIgnoreCase("athebalt_q73_2.htm")) {
            if (st.getCond() == 1)
                st.setCond(2);
        } else if (event.equalsIgnoreCase("rifken_q73_2.htm")) {
            if (st.getCond() == 2)
                st.setCond(3);
        } else if (event.equalsIgnoreCase("rifken_q73_4.htm")) {
            if (st.getCond() == 4)
                st.setCond(5);
            st.takeItems(OSKOLOK_KRI_HOLODA, -1);
        } else if (event.equalsIgnoreCase("athebalt_q73_4.htm")) {
            if (st.getCond() == 5)
                st.setCond(6);
            ...
            if (st.getCond() == 10)
                st.setCond(11);
        } else if (event.equalsIgnoreCase("athebalt_q73_6.htm")) {
            if (st.getCond() == 11)
                st.setCond(12);
        ...
        } else if (event.equalsIgnoreCase("sedrik_q73_7.htm")) {
            if (st.getCond() == 18) {
                ...
                player.setClassId(ClassId.DUELIST.getId(), false);
                if (player.getBaseClassId() == ClassId.GLADIATOR.getId())
                    player.setClassId(ClassId.DUELIST.getId(), false);
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == SEDRIK) {
            if (cond == 0) {
                if (st.getPlayer().getLevel() >= 76 && st.getPlayer().getClassId().getId() == 2)

                    htmltext = "sedrik_q73_01.htm";
                else
                    htmltext = "sedrik_q73_03.htm";
            }
            if (cond == 1) {
                htmltext = "sedrik_q73_01s.htm";
            }
            if (cond == 18) {
                htmltext = "sedrik_q73_6.htm";
            }

        }
        if (npcId == ATHEBALT) {
            if (cond == 1) {
                htmltext = "athebalt_q73_1.htm";
            }
            if (cond == 2) {
                htmltext = "athebalt_q73_2.htm";
            }
            if (cond == 5) {
                htmltext = "athebalt_q73_3.htm";
            }
            if (cond == 6) {
                htmltext = "athebalt_q73_4.htm";
            }
        }
        if (npcId == FELIX) {
            if (cond == 11) {
                htmltext = "athebalt_q73_5.htm";
            }
            if (cond == 12) {
                htmltext = "athebalt_q73_6.htm";
            }
        }
        if (npcId == RIFKEN) {
            if (cond == 2) {
                htmltext = "rifken_q73_1.htm";
            }
            if (cond == 3) {
                htmltext = "rifken_q73_2.htm";
            }
            if (cond == 4) {
                htmltext = "rifken_q73_3.htm";
            }
        }

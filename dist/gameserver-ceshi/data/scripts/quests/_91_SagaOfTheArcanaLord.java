...
public class _91_SagaOfTheArcanaLord extends Quest {
    ...
    public final int AIKEN = 31605;//kinsli
    public final int JER = 31585;//sparki
    public final int RIFKEN = 31622;//kits
    public final int BELINDA = 31608;//belinda
    ...
    public final int BLUSTITEL = 27214;   //1 hranitel
    public final int AIRON = 27313; //2 wakiel
    public final int ARHONT_HALIWI = 27219;
    public final int TENBELEFA = 27310;//3 kitanis
    public final int KAIN = 31586;//4 sparki
    ...
    public final int OSKOLOK_KRI_HOLODA = 49825;
    public final int ZNAK_HALIWI = 7506;
    ...
    public _91_SagaOfTheArcanaLord() {
        ...
        addKillNpcWithLog(16, D_LIST, 1, 27310);//3
        ...
        addClassIdCheck("aiken03.htm", 14);
    }
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("aiken02a.htm")) {
            ...
            if (st.getCond() == 18) {
                ...
                player.setClassId(ClassId.ARCANA_LORD.getId(), false);
                if (player.getBaseClassId() == ClassId.WARLOCK.getId())
                    player.setClassId(ClassId.ARCANA_LORD.getId(), false);
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == AIKEN) {
            if (cond == 0) {
                if (st.getPlayer().getLevel() >= 76 && st.getPlayer().getClassId().getId() == 14)

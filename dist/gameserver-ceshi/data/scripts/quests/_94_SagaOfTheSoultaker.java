...
public class _94_SagaOfTheSoultaker extends Quest {
    ...
    public final int AIKEN = 30832;//hardin
    public final int JER = 30857;//orven
    public final int RIFKEN = 34271;//ruru
    ...
    public final int BLUSTITEL = 27215;   //1 smotrit
    public final int AIRON = 27257; //2 arhan bogoborec
    public final int ARHONT_HALIWI = 27219;
    public final int TENBELEFA = 27265;//3 korol lichey ikar
    public final int KAIN = 31645;//4 hindemit
    ...
    public final int OSKOLOK_KRI_HOLODA = 49828;
    public final int ZNAK_HALIWI = 7509;
    ...
    public _94_SagaOfTheSoultaker() {
        ...
        addKillNpcWithLog(16, D_LIST, 1, 27265);//3
        ...
        addClassIdCheck("aiken03.htm", 13);
    }
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("aiken02a.htm")) {
            ...
            if (st.getCond() == 18) {
                ...
                player.setClassId(ClassId.SOULTAKER.getId(), false);
                if (player.getBaseClassId() == ClassId.NECROMANCER.getId())
                    player.setClassId(ClassId.SOULTAKER.getId(), false);
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == AIKEN) {
            if (cond == 0) {
                if (st.getPlayer().getLevel() >= 76 && st.getPlayer().getClassId().getId() == 13)

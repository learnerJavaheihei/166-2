...
//SanyaDC
public class _89_SagaOfTheMysticMuse extends Quest {
    ...
    public final int JER = 30856;//винонин
    public final int RIFKEN = 34270;//брум
    ...
    public final int TENBELEFA = 27254;//3 таин демон моб
    public final int KAIN = 31643;//4 фейшар
    ...
    public final int OSKOLOK_KRI_HOLODA = 49823;
    public final int ZNAK_HALIWI = 7504;
    ...
    public _89_SagaOfTheMysticMuse() {
        ...
        addClassIdCheck("aiken03.htm", 27);
    }
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("aiken02a.htm")) {
            ...
            if (st.getCond() == 18) {
                ...
                player.setClassId(ClassId.MYSTIC_MUSE.getId(), false);
                if (player.getBaseClassId() == ClassId.SPELLSINGER.getId())
                    player.setClassId(ClassId.MYSTIC_MUSE.getId(), false);
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == AIKEN) {
            if (cond == 0) {
                if (st.getPlayer().getLevel() >= 76 && st.getPlayer().getClassId().getId() == 27)

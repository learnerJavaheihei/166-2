...
public class _11015_PrepareForTrade13 extends Quest
{
	...
	//items
	public final int YADRO = 90250;
	public final int POROWOK = 90251;
	public final int WKYRA = 90252;
	...
	public _11015_PrepareForTrade13()
	{
		...
		addQuestCompletedCheck("questnotdone.htm", 11014);		
	}
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		if(event.equalsIgnoreCase("pain2.htm"))
		{
			st.setCond(1);
		}
		else if(event.equalsIgnoreCase("volodos2.htm"))
		{			
				st.setCond(2);
		}

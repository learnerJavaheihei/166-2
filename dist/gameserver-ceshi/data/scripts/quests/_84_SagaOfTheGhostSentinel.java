...
public class _84_SagaOfTheGhostSentinel extends Quest {
    ...
    public final int AIKEN = 30702;//бернард
    public final int JER = 31604;//гест
    public final int RIFKEN = 30842;//алексис
    ...
    public final int OSKOLOK_KRI_HOLODA = 49818;
    public final int ZNAK_HALIWI = 7499;
    ...
    public _84_SagaOfTheGhostSentinel() {
        ...
        addClassIdCheck("aiken03.htm", 37);
    }
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("aiken02a.htm")) {
            ...
            if (st.getCond() == 18) {
                ...
                player.setClassId(ClassId.GHOST_SENTINEL.getId(), false);
                if (player.getBaseClassId() == ClassId.PHANTOM_RANGER.getId())
                    player.setClassId(ClassId.GHOST_SENTINEL.getId(), false);
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == AIKEN) {
            if (cond == 0) {
                if (st.getPlayer().getLevel() >= 76 && st.getPlayer().getClassId().getId() == 37)

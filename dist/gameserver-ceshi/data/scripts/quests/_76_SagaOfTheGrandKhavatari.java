...
public class _76_SagaOfTheGrandKhavatari extends Quest {
    ...
    public final int AIKEN = 30866;//марестел
    public final int JER = 30593;//дуда мара
    ...
    public final int KAMEN_POZNANIA4 = 31657;
    //mobs
    ...
    public final int AIRON = 27293; //2 уруз
    public final int ARHONT_HALIWI = 27219;
    public final int TENBELEFA = 27284;//3 моб азира
    public final int KAIN = 31637;// каши
    ...
    //items
    public final int BOOKGOLDLION = 90042;
    public final int OSKOLOK_KRI_HOLODA = 49810;
    public final int ZNAK_HALIWI = 7491;
    ...
    public _76_SagaOfTheGrandKhavatari() {
        ...
        addKillNpcWithLog(9, B_LIST, 1, 27293);//2
        addKillNpcWithLog(13, C_LIST, 1, ARHONT_HALIWI);
        addKillNpcWithLog(16, D_LIST, 1, 27284);//3
        ...
        addClassIdCheck("aiken03.htm", 48);
    }
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("aiken02a.htm")) {
            ...
            if (st.getCond() == 18) {
                ...
                player.setClassId(ClassId.GRAND_KHAVATARI.getId(), false);
                if (player.getBaseClassId() == ClassId.TYRANT.getId())
                    player.setClassId(ClassId.GRAND_KHAVATARI.getId(), false);
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == AIKEN) {
            if (cond == 0) {
                if (st.getPlayer().getLevel() >= 76 && st.getPlayer().getClassId().getId() == 48)

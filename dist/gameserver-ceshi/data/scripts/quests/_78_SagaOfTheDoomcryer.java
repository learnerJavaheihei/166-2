...
public class _78_SagaOfTheDoomcryer extends Quest {
    ...
    public final int AIKEN = 30867;//рева
    public final int JER = 30593;//дуда
    ...
    public final int AIRON = 27295; //2 мадаха
    public final int ARHONT_HALIWI = 27219;
    public final int TENBELEFA = 27285;//3 моб тотем
    public final int KAIN = 31642;// дуда мара
    ...
    public final int OSKOLOK_KRI_HOLODA = 49812;
    public final int ZNAK_HALIWI = 7493;
    ...
    public _78_SagaOfTheDoomcryer() {
        ...
        addKillNpcWithLog(9, B_LIST, 1, 27295);//2
        addKillNpcWithLog(13, C_LIST, 1, ARHONT_HALIWI);
        addKillNpcWithLog(16, D_LIST, 1, 27285);//3
        ...
        addClassIdCheck("aiken03.htm", 52);
    }
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("aiken02a.htm")) {
            ...
            if (st.getCond() == 18) {
                ...
                player.setClassId(ClassId.DOOMCRYER.getId(), false);
                if (player.getBaseClassId() == ClassId.WARCRYER.getId())
                    player.setClassId(ClassId.DOOMCRYER.getId(), false);
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == AIKEN) {
            if (cond == 0) {
                if (st.getPlayer().getLevel() >= 76 && st.getPlayer().getClassId().getId() == 52)

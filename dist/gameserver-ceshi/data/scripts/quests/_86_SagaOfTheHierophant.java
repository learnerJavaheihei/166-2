...
public class _86_SagaOfTheHierophant extends Quest {
    ...
    public final int AIKEN = 30857;//orven
    public final int JER = 30657;//seresin
    public final int RIFKEN = 34268;//kits
    public final int BELINDA = 30861;//Леонард
    public final int KAMEN_POZNANIA1 = 31646;
    public final int KAMEN_POZNANIA2 = 31648;
    public final int KAMEN_POZNANIA3 = 31650;
    ...
    public final int BLUSTITEL = 27215;   //1 smotritel
    public final int AIRON = 27269; //2 Навериус
    public final int ARHONT_HALIWI = 27219;
    public final int TENBELEFA = 27274;//3 Танакиа моб
    public final int KAIN = 31591;//4 Луна Проводник Заката
    ...
    public final int OSKOLOK_KRI_HOLODA = 49820;
    public final int ZNAK_HALIWI = 7501;
    ...
    public _86_SagaOfTheHierophant() {
        ...
        addKillNpcWithLog(9, B_LIST, 1, 27269);//2
        addKillNpcWithLog(13, C_LIST, 1, ARHONT_HALIWI);
        addKillNpcWithLog(16, D_LIST, 1, 27274);//3
        ...
        addClassIdCheck("aiken03.htm", 17);
    }
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("aiken02a.htm")) {
            ...
            if (st.getCond() == 18) {
                ...
                player.setClassId(ClassId.HIEROPHANT.getId(), false);
                if (player.getBaseClassId() == ClassId.PROPHET.getId())
                    player.setClassId(ClassId.HIEROPHANT.getId(), false);
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == AIKEN) {
            if (cond == 0) {
                if (st.getPlayer().getLevel() >= 76 && st.getPlayer().getClassId().getId() == 17)

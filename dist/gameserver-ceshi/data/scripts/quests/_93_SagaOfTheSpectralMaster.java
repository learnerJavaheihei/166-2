...
public class _93_SagaOfTheSpectralMaster extends Quest {
    ...
    public final int JER = 31613;//ноктис
    public final int RIFKEN = 30476;//кайра
    ...
    public final int AIRON = 27313; //2 шакиэль
    public final int ARHONT_HALIWI = 27219;
    public final int TENBELEFA = 27312;//3 моб служитель
    public final int KAIN = 31632;// загадочный
    ...
    public final int OSKOLOK_KRI_HOLODA = 49827;
    public final int ZNAK_HALIWI = 7508;
    ...
    public _93_SagaOfTheSpectralMaster() {
        ...
        addKillNpcWithLog(16, D_LIST, 1, 27312);//3
        ...
        addClassIdCheck("aiken03.htm", 41);
    }
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("aiken02a.htm")) {
            ...
            if (st.getCond() == 18) {
                ...
                player.setClassId(ClassId.SPECTRAL_MASTER.getId(), false);
                if (player.getBaseClassId() == ClassId.PHANTOM_SUMMONER.getId())
                    player.setClassId(ClassId.SPECTRAL_MASTER.getId(), false);
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == AIKEN) {
            if (cond == 0) {
                if (st.getPlayer().getLevel() >= 76 && st.getPlayer().getClassId().getId() == 41)

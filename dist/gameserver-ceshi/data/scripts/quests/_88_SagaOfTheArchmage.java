...
public class _88_SagaOfTheArchmage extends Quest {
    ...
    public final int AIKEN = 30176;//valeria
    public final int JER = 30855;//desmond
    public final int RIFKEN = 34270;//broom
    ...
    public final int BLUSTITEL = 27216;   //1 blyst
    public final int AIRON = 27250; //2 padw ang alekt
    public final int ARHONT_HALIWI = 27219;
    public final int TENBELEFA = 27254;//3 tainst dem
    public final int KAIN = 31590;//4 devian
    ...
    public final int OSKOLOK_KRI_HOLODA = 49822;
    public final int ZNAK_HALIWI = 7503;
    ...
    public _88_SagaOfTheArchmage() {
        ...
        addClassIdCheck("aiken03.htm", 12);
    }
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("aiken02a.htm")) {
            ...
            if (st.getCond() == 18) {
                ...
                player.setClassId(ClassId.ARCHMAGE.getId(), false);
                if (player.getBaseClassId() == ClassId.SORCERER.getId())
                    player.setClassId(ClassId.ARCHMAGE.getId(), false);
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == AIKEN) {
            if (cond == 0) {
                if (st.getPlayer().getLevel() >= 76 && st.getPlayer().getClassId().getId() == 12)

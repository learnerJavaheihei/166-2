...
public class _83_SagaOfTheMoonlightSentinel extends Quest {
    ...
    public final int JER = 31604;//гримст
    ...
    public final int KAIN = 31633;//4 кадит
    ...
    public final int OSKOLOK_KRI_HOLODA = 49817;
    public final int ZNAK_HALIWI = 7498;
    ...
    public _83_SagaOfTheMoonlightSentinel() {
        ...
        addClassIdCheck("aiken03.htm", 24);
    }
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("aiken02a.htm")) {
            ...
            if (st.getCond() == 18) {
                ...
                player.setClassId(ClassId.MOONLIGHT_SENTINEL.getId(), false);
                if (player.getBaseClassId() == ClassId.SILVER_RANGER.getId())
                    player.setClassId(ClassId.MOONLIGHT_SENTINEL.getId(), false);
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == AIKEN) {
            if (cond == 0) {
                if (st.getPlayer().getLevel() >= 76 && st.getPlayer().getClassId().getId() == 24)

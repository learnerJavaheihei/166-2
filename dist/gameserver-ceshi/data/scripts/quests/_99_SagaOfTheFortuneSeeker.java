...
public class _99_SagaOfTheFortuneSeeker extends Quest {
    ...
    public final int AIKEN = 31594;//монд
    public final int JER = 34267;//дазлинг
    public final int RIFKEN = 34271;//руру
    //public final int BELINDA = 30706;//лазенбай
    public final int KAMEN_POZNANIA1 = 31646;
    public final int KAMEN_POZNANIA2 = 31648;
    public final int KAMEN_POZNANIA3 = 31651;
    public final int KAMEN_POZNANIA4 = 31658;
    //mobs
    ...
    public final int BLUSTITEL = 27215;   //1 смотритель
    public final int AIRON = 27257; //2 богоборец
    public final int ARHONT_HALIWI = 27219;
    public final int TENBELEFA = 27309;//3 моб хакен
    public final int KAIN = 31601;// памела андерсон
    ...
    //items
    public final int BOOKGOLDLION = 90041;
    public final int OSKOLOK_KRI_HOLODA = 49833;
    public final int ZNAK_HALIWI = 7514;
    ...
    public _99_SagaOfTheFortuneSeeker() {
        ...
        addKillNpcWithLog(9, B_LIST, 1, 27257);//2
        addKillNpcWithLog(13, C_LIST, 1, ARHONT_HALIWI);
        addKillNpcWithLog(16, D_LIST, 1, 27309);//3
        ...
        addClassIdCheck("aiken03.htm", 55);
    }
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("aiken02a.htm")) {
            ...
            if (st.getCond() == 18) {
                ...
                player.setClassId(ClassId.FORTUNE_SEEKER.getId(), false);
                if (player.getBaseClassId() == ClassId.BOUNTY_HUNTER.getId())
                    player.setClassId(ClassId.FORTUNE_SEEKER.getId(), false);
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == AIKEN) {
            if (cond == 0) {
                if (st.getPlayer().getLevel() >= 76 && st.getPlayer().getClassId().getId() == 55)

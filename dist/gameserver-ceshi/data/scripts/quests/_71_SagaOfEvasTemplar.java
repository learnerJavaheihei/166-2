...
public class _71_SagaOfEvasTemplar extends Quest {
    ...
    public final int AIKEN = 30852;//синден
    public final int JER = 30692;//стедмиэлем
    public final int RIFKEN = 34268;//рифкен
    public final int BELINDA = 31281;//керенас
    ...
    public final int AIRON = 27287; //2 панацей
    public final int ARHONT_HALIWI = 27219;
    public final int TENBELEFA = 27279;//3 кесадейн
    public final int KAIN = 31638;//4 кастиен
    ...
    public final int OSKOLOK_KRI_HOLODA = 49805;
    public final int ZNAK_HALIWI = 7486;
    ...
    public _71_SagaOfEvasTemplar() {
        ...
        addKillNpcWithLog(9, B_LIST, 1, 27287);//2
        addKillNpcWithLog(13, C_LIST, 1, ARHONT_HALIWI);
        addKillNpcWithLog(16, D_LIST, 1, 27279);//3
        ...
        addClassIdCheck("aiken03.htm", 20);
    }
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("aiken02a.htm")) {
            ...
            if (st.getCond() == 18) {
                ...
                player.setClassId(ClassId.EVAS_TEMPLAR.getId(), false);
                if (player.getBaseClassId() == ClassId.TEMPLE_KNIGHT.getId())
                    player.setClassId(ClassId.EVAS_TEMPLAR.getId(), false);
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == AIKEN) {
            if (cond == 0) {
                if (st.getPlayer().getLevel() >= 76 && st.getPlayer().getClassId().getId() == 20)

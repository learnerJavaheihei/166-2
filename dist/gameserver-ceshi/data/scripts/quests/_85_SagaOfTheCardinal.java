...
public class _85_SagaOfTheCardinal extends Quest {
    ...
    public final int AIRON = 27266; //2 хаурес
    public final int ARHONT_HALIWI = 27219;
    public final int TENBELEFA = 27302;//3 азраэль моб
    public final int KAIN = 31633;//4 зимн ох кадид
    ...
    public final int OSKOLOK_KRI_HOLODA = 49819;
    public final int ZNAK_HALIWI = 7500;
    ...
    public _85_SagaOfTheCardinal() {
        ...
        addKillNpcWithLog(9, B_LIST, 1, 27266);//2
        ...
        addClassIdCheck("aiken03.htm", 16);
    }
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("aiken02a.htm")) {
            ...
            if (st.getCond() == 18) {
                ...
                player.setClassId(ClassId.CARDINAL.getId(), false);
                if (player.getBaseClassId() == ClassId.BISHOP.getId())
                    player.setClassId(ClassId.CARDINAL.getId(), false);
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == AIKEN) {
            if (cond == 0) {
                if (st.getPlayer().getLevel() >= 76 && st.getPlayer().getClassId().getId() == 16)

...
public class _74_SagaOfTheDreadnought extends Quest {
    ...
    public final int JER = 30121;
    public final int RIFKEN = 34268;
    public final int FELIX = 30832;
    ...
    public final int AIRON = 27290; //2
    public final int ARHONT_HALIWI = 27219;
    public final int TENBELEFA = 27282;//3
    public final int KAIN = 31595;//4
    ...
    public final int OSKOLOK_KRI_HOLODA = 49808;
    public final int ZNAK_HALIWI = 7489;
    ...
    public _74_SagaOfTheDreadnought() {
        ...
        addKillNpcWithLog(9, B_LIST, 1, 27290);//2
        addKillNpcWithLog(13, C_LIST, 1, ARHONT_HALIWI);
        addKillNpcWithLog(16, D_LIST, 1, 27282);//3
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("aiken02a.htm")) {
            ...
            if (st.getCond() == 18) {
                ...
                player.setClassId(ClassId.DREADNOUGHT.getId(), false);
                if (player.getBaseClassId() == ClassId.WARLORD.getId())
                    player.setClassId(ClassId.DREADNOUGHT.getId(), false);
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == AIKEN) {
            if (cond == 0) {
                if (st.getPlayer().getLevel() >= 76 && st.getPlayer().getClassId().getId() == 3)

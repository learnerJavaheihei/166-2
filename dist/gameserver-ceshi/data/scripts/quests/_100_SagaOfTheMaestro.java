...
public class _100_SagaOfTheMaestro extends Quest {
    ...
    public final int AIKEN = 30764;//бальтазар
    public final int JER = 31597;//тобальд
    public final int RIFKEN = 34272;//михай
    ...
    public final int TENBELEFA = 27308;//3 моб лед ассасин
    public final int KAIN = 31596;// тобальд2
    ...
    public final int OSKOLOK_KRI_HOLODA = 49834;
    public final int ZNAK_HALIWI = 7515;
    ...
    public _100_SagaOfTheMaestro() {
        ...
        addKillNpcWithLog(16, D_LIST, 1, 27308);//3
        ...
        addClassIdCheck("aiken03.htm", 57);
    }
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("aiken02a.htm")) {
            ...
            if (st.getCond() == 18) {
                ...
                player.setClassId(ClassId.MAESTRO.getId(), false);
                if (player.getBaseClassId() == ClassId.WARSMITH.getId())
                    player.setClassId(ClassId.MAESTRO.getId(), false);
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == AIKEN) {
            if (cond == 0) {
                if (st.getPlayer().getLevel() >= 76 && st.getPlayer().getClassId().getId() == 57)

...
public class _75_SagaOfTheTitan extends Quest {
    ...
    public final int AIKEN = 30865;//ладанза
    public final int JER = 30704;//сересин
    ...
    public final int AIRON = 27292; //2 мухарк
    public final int ARHONT_HALIWI = 27219;
    public final int TENBELEFA = 27283;//3 моб аскалиус
    public final int KAIN = 31607;// хестуи
    ...
    public final int OSKOLOK_KRI_HOLODA = 49809;
    public final int ZNAK_HALIWI = 7490;
    ...
    public _75_SagaOfTheTitan() {
        ...
        addKillNpcWithLog(9, B_LIST, 1, 27292);//2
        addKillNpcWithLog(13, C_LIST, 1, ARHONT_HALIWI);
        addKillNpcWithLog(16, D_LIST, 1, 27283);//3
        ...
        addClassIdCheck("aiken03.htm", 46);
    }
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("aiken02a.htm")) {
            ...
            if (st.getCond() == 18) {
                ...
                player.setClassId(ClassId.TITAN.getId(), false);
                if (player.getBaseClassId() == ClassId.DESTROYER.getId())
                    player.setClassId(ClassId.TITAN.getId(), false);
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == AIKEN) {
            if (cond == 0) {
                if (st.getPlayer().getLevel() >= 76 && st.getPlayer().getClassId().getId() == 46)

...
public class _11021_RedGemNecklace13 extends Quest
{
	...
	//items
	public final int KOST = 90275;
	public final int LAPKA = 90276;	
	...
	public _11021_RedGemNecklace13()
	{
		...
		addQuestCompletedCheck("questnotdone.htm", 11020);		
	}
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		if(event.equalsIgnoreCase("sumari2.htm"))
		{
			st.setCond(1);
		}
		else if(event.equalsIgnoreCase("aska2.htm"))
		{			
				st.setCond(2);
		}

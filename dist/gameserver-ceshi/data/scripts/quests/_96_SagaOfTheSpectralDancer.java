...
public class _96_SagaOfTheSpectralDancer extends Quest {
    ...
    public final int AIKEN = 31582;//мордред
    ...
    public final int AIRON = 27272; //2 лилиан
    public final int ARHONT_HALIWI = 27219;
    public final int TENBELEFA = 27262;//3 халлет
    public final int KAIN = 31611;// харт
    ...
    public final int OSKOLOK_KRI_HOLODA = 49830;
    public final int ZNAK_HALIWI = 7511;
    ...
    public _96_SagaOfTheSpectralDancer() {
        ...
        addKillNpcWithLog(9, B_LIST, 1, 27272);//2
        ...
        addClassIdCheck("aiken03.htm", 34);
    }
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("aiken02a.htm")) {
            ...
            if (st.getCond() == 18) {
                ...
                player.setClassId(ClassId.SPECTRAL_DANCER.getId(), false);
                if (player.getBaseClassId() == ClassId.BLADEDANCER.getId())
                    player.setClassId(ClassId.SPECTRAL_DANCER.getId(), false);
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == AIKEN) {
            if (cond == 0) {
                if (st.getPlayer().getLevel() >= 76 && st.getPlayer().getClassId().getId() == 34)

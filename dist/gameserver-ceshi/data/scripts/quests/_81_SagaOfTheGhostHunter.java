...
public class _81_SagaOfTheGhostHunter extends Quest {
    ...
    public final int AIKEN = 31603;//кошка
    public final int JER = 30863;//гест
    ...
    public final int TENBELEFA = 27302;//3 азраель
    public final int KAIN = 31617;// фестматер
    ...
    public final int OSKOLOK_KRI_HOLODA = 49815;
    public final int ZNAK_HALIWI = 7496;
    ...
    public _81_SagaOfTheGhostHunter() {
        ...
        addClassIdCheck("aiken03.htm", 36);
    }
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("aiken02a.htm")) {
            ...
            if (st.getCond() == 18) {
                ...
                player.setClassId(ClassId.GHOST_HUNTER.getId(), false);
                if (player.getBaseClassId() == ClassId.ABYSS_WALKER.getId())
                    player.setClassId(ClassId.GHOST_HUNTER.getId(), false);
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == AIKEN) {
            if (cond == 0) {
                if (st.getPlayer().getLevel() >= 76 && st.getPlayer().getClassId().getId() == 36)

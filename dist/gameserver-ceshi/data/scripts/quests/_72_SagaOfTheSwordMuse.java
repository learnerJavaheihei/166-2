...
public class _72_SagaOfTheSwordMuse extends Quest {
    ...
    public final int AIKEN = 30853;//раен
    public final int JER = 30097;//галадуччи
    ...
    public final int AIRON = 27288; //2 биэль
    public final int ARHONT_HALIWI = 27219;
    public final int TENBELEFA = 27280;//3 нарцисс
    public final int KAIN = 31618;//4 ирен
    ...
    public final int OSKOLOK_KRI_HOLODA = 49806;
    public final int ZNAK_HALIWI = 7487;
    ...
    public _72_SagaOfTheSwordMuse() {
        ...
        addKillNpcWithLog(9, B_LIST, 1, 27288);//2
        addKillNpcWithLog(13, C_LIST, 1, ARHONT_HALIWI);
        addKillNpcWithLog(16, D_LIST, 1, 27280);//3
        ...
        addClassIdCheck("aiken03.htm", 21);
    }
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("aiken02a.htm")) {
            ...
            if (st.getCond() == 18) {
                ...
                player.setClassId(ClassId.SWORD_MUSE.getId(), false);
                if (player.getBaseClassId() == ClassId.SWORDSINGER.getId())
                    player.setClassId(ClassId.SWORD_MUSE.getId(), false);
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == AIKEN) {
            if (cond == 0) {
                if (st.getPlayer().getLevel() >= 76 && st.getPlayer().getClassId().getId() == 21)

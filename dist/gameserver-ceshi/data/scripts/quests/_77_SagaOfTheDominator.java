...
public class _77_SagaOfTheDominator extends Quest {
    ...
    public final int JER = 34265;//мукта
    ...
    public final int AIRON = 27294; //2 атрус
    public final int ARHONT_HALIWI = 27219;
    public final int TENBELEFA = 27262;//3 моб халлет
    public final int KAIN = 31636;// аккан
    ...
    public final int OSKOLOK_KRI_HOLODA = 49811;
    public final int ZNAK_HALIWI = 7492;
    ...
    public _77_SagaOfTheDominator() {
        ...
        addKillNpcWithLog(9, B_LIST, 1, 27294);//2
        addKillNpcWithLog(13, C_LIST, 1, ARHONT_HALIWI);
        addKillNpcWithLog(16, D_LIST, 1, 27262);//3
        ...
        addClassIdCheck("aiken03.htm", 51);
    }
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("aiken02a.htm")) {
            ...
            if (st.getCond() == 18) {
                ...
                player.setClassId(ClassId.DOMINATOR.getId(), false);
                if (player.getBaseClassId() == ClassId.OVERLORD.getId())
                    player.setClassId(ClassId.DOMINATOR.getId(), false);
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == AIKEN) {
            if (cond == 0) {
                if (st.getPlayer().getLevel() >= 76 && st.getPlayer().getClassId().getId() == 51)

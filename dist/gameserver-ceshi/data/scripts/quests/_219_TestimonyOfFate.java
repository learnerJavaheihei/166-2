...
public final class _219_TestimonyOfFate extends Quest
{
	...
	public String onEvent(String event, QuestState st, NpcInstance npc)
	{
		...
		{
			List<NpcInstance> isQuests = GameObjectsStorage.getNpcs(true, AldersSpirit);
			if(!isQuests.isEmpty())
		...
		switch(npcId)
		{
			case Kaira:
				...
				else if(cond == 9 || cond == 10)
				{
					...
					List<NpcInstance> AldersSpiritObjects = GameObjectsStorage.getNpcs(true, AldersSpirit);
					if(AldersSpiritObjects.isEmpty())
					{

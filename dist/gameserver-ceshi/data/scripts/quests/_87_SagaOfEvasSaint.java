...
public class _87_SagaOfEvasSaint extends Quest {
    ...
    public final int AIKEN = 30857;//орвен
    public final int JER = 30657;//сересин
    public final int RIFKEN = 34268;//рифкен
    public final int BELINDA = 30859;//вивиан
    ...
    public final int TENBELEFA = 27274;//3 танакиа
    public final int KAIN = 31620;//4 калейдос
    ...
    public final int OSKOLOK_KRI_HOLODA = 49821;
    public final int ZNAK_HALIWI = 7502;
    ...
    public _87_SagaOfEvasSaint() {
        ...
        addClassIdCheck("aiken03.htm", 30);
    }
    ...
    public String onEvent(String event, QuestState st, NpcInstance npc) {
        ...
        if (event.equalsIgnoreCase("aiken02a.htm")) {
            ...
            if (st.getCond() == 18) {
                ...
                player.setClassId(ClassId.EVAS_SAINT.getId(), false);
                if (player.getBaseClassId() == ClassId.ELDER.getId())
                    player.setClassId(ClassId.EVAS_SAINT.getId(), false);
    ...
    public String onTalk(NpcInstance npc, QuestState st) {
        ...
        if (npcId == AIKEN) {
            if (cond == 0) {
                if (st.getPlayer().getLevel() >= 76 && st.getPlayer().getClassId().getId() == 30)

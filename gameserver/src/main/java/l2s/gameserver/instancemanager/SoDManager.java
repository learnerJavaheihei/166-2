...
public class SoDManager
{
  ...
  public static boolean isAttackStage() { return (getOpenedTimeLimit() <= 0L); }
  ...
  public static int getTiatKills() { return ServerVariables.getInt("Tial_kills", 0); }

  private static long getOpenedTimeLimit() { return ServerVariables.getLong("SoD_opened", 0L) * 1000L - System.currentTimeMillis(); }

  private static Zone getZone() { return _zone; }

  public static void teleportIntoSeed(Player p) { p.teleToLocation(new Location(-245800, 220488, -12112)); }

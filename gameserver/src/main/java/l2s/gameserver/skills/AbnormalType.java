...
public enum AbnormalType
{
	...
	RESEARCH_FAIL(-1), // 研究失敗
	RESEARCH_REWARD(-1), // 2-8倍獎勵
	RESEARCH_SUCCESS(-1), // 研究成功
	LA_VIE_EN_ROSES_ENERGY(-1), // TODO: name, id
	SHIELD_OF_SACRIFICE(-1), // 獻祭之盾、伊娃保護
	AGATHION_SONG_DANCE(-1), // 絕美舞姿、圓錐之舞、風之歌
	GREATER_MIGHT(-1), // 高級力量強化
	GREATER_SHIELD(-1), // 高級保護盾
	FIRE_RAGE(-1), //伊格尼斯王 火焰怒擊
	ELEMENTAL_EXP_RATE(-1); // 精靈祝福、中級精靈祝福、上級精靈祝福

...
public class i_call_skill extends i_abstract_effect
{
	...
	public void instantUse(Creature effector, Creature effected, boolean reflected)
	{
		...
		if(_skillEntry.checkCondition(effector, aimTarget, true, true, true, false, true))
		{
			//修復芙蕾雅即時地區報錯--
			if((effector == null) ||(aimTarget == null)  )
			{
				return;
			}
			//--修復芙蕾雅即時地區報錯
			Set<Creature> targets = skill.getTargets(_skillEntry, effector, aimTarget, false);
			...
			effector.callSkill(aimTarget, SkillEntry.makeSkillEntry(SkillEntryType.NONE, skill), targets, false, true);

...
public class AdminShutdown implements IAdminCommandHandler
{
	...
	private void sendHtmlForm(Player activeChar)
	{
		...
		replyMSG.append("<td width=180><center>關機/重啟管理</center></td>");
		...
		replyMSG.append("<tr><td width=100>線上玩家:</td><td width=200>" + realOnline + "</td></tr>");
		replyMSG.append("<tr><td width=100>離線商人:</td><td width=200>" + (totalOnline - realOnline) + "</td></tr>");
		replyMSG.append("<tr><td width=100>真實人數:</td><td width=200>" + GameObjectsStorage.getPlayersReall() + "</td></tr>");
		replyMSG.append("<tr><td width=100>記憶體:</td><td width=200>" + StatsUtils.getMemUsedMb() + "</td></tr>");
		replyMSG.append("<tr><td width=100>伺服器倍率:</td><td width=200></td></tr>");
		...
		replyMSG.append("<tr><td>時間單位秒:</td></tr>");
		replyMSG.append("<br>");
		replyMSG.append("<tr><td><center>輸入時間: <edit var=\"shutdown_time\" width=60></center></td></tr>");
		replyMSG.append("</table><br>");
		replyMSG.append("<center><table><tr><td>");
		replyMSG.append("<button value=\"關機\" action=\"bypass -h admin_server_shutdown $shutdown_time\" width=80 height=25 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td><td>");
		replyMSG.append("<button value=\"重啟\" action=\"bypass -h admin_server_restart $shutdown_time\" width=80 height=25 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\"></td><td>");
		replyMSG.append("<button value=\"中斷操作\" action=\"bypass -h admin_server_abort\" width=80 height=25 back=\"L2UI_CT1.Button_DF_Down\" fore=\"L2UI_CT1.Button_DF\">");

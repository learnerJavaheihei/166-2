		...
		if(activeChar.getPlayerAccess().Menu)
		{
			...
			switch(command)
			{
				...
				case admin_debug:
					...
					_s.add("==Magic Power: " + pl.getStat().calc(Stats.MAGIC_POWER, 1, null, null));
					_s.add("==P. Skill Power: " + pl.getStat().calc(Stats.P_SKILL_POWER, 1, null, null));
					_s.add("==Cast Break Rate: " + pl.getStat().calc(Stats.CAST_INTERRUPT, 1, null, null));
					...
					_s.add("==Cancel: " + pl.getStat().calc(Stats.CANCEL_POWER, 1, null, null));
					_s.add("==Buff: " + pl.getStat().calc(Stats.RESIST_ABNORMAL_BUFF, 1, null, null));
					_s.add("==Debuff: " + pl.getStat().calc(Stats.RESIST_ABNORMAL_DEBUFF, 1, null, null));

					_s.add("==========PvP Stats:");
					_s.add("==Phys Attack Dmg: " + pl.getStat().calc(Stats.PVP_PHYS_DMG_BONUS, 1, null, null));
					_s.add("==Phys Skill Dmg: " + pl.getStat().calc(Stats.PVP_PHYS_SKILL_DMG_BONUS, 1, null, null));
					_s.add("==Magic Skill Dmg: " + pl.getStat().calc(Stats.PVP_MAGIC_SKILL_DMG_BONUS, 1, null, null));
					_s.add("==Phys Attack Def: " + pl.getStat().calc(Stats.PVP_PHYS_DEFENCE_BONUS, 1, null, null));
					_s.add("==Phys Skill Def: " + pl.getStat().calc(Stats.PVP_PHYS_SKILL_DEFENCE_BONUS, 1, null, null));
					_s.add("==Magic Skill Def: " + pl.getStat().calc(Stats.PVP_MAGIC_SKILL_DEFENCE_BONUS, 1, null, null));
					...
					_s.add("==Magic Skills: " + pl.getStat().calc(Stats.MP_MAGIC_SKILL_CONSUME, 1, null, null));
					_s.add("==Phys Skills: " + pl.getStat().calc(Stats.MP_PHYSICAL_SKILL_CONSUME, 1, null, null));
					_s.add("==Music: " + pl.getStat().calc(Stats.MP_DANCE_SKILL_CONSUME, 1, null, null));
					...
					_s.add("==Phys Skill Evasion Rate: " + (pl.getStat().calc(Stats.P_SKILL_EVASION, 100, null, null) - 100));

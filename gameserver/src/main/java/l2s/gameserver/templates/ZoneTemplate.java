...
import l2s.gameserver.model.Zone.ZoneTarget;
...
public class ZoneTemplate extends StatTemplate
{
	...
	private final boolean _canLostExp;
	...
	public ZoneTemplate(StatsSet set)
	{
		...
		_canLostExp = set.getBool("can_lost_exp", _type != ZoneType.battle_zone);

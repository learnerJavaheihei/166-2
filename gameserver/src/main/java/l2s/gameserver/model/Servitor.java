...
public abstract class Servitor extends Playable
{
	...
	public void broadcastStatusUpdate()
	{
		...
		broadcastPacket(new StatusUpdate(this, StatusUpdatePacket.UpdateType.DEFAULT, StatusUpdatePacket.CUR_HP, StatusUpdatePacket.MAX_HP));
	...
	public void displayGiveDamageMessage(Creature target, Skill skill, int damage, Servitor servitorTransferedDamage, int transferedDamage, boolean crit, boolean miss, boolean shld, boolean blocked, int elementalDamage, boolean elementalCrit)
	{
		...
		if(miss)
		{
			if(skill == null)
				...
				getPlayer().sendPacket(new ExMagicAttackInfo(getPlayer().getObjectId(), target.getObjectId(), ExMagicAttackInfo.EVADED)); // TODO: Нужно ли?
			return;
		}
		...
		if(crit)
		{
			/*if(skill != null)
			{
				...
				getPlayer().sendPacket(new ExMagicAttackInfo(getPlayer().getObjectId(), target.getObjectId(), ExMagicAttackInfo.CRITICAL));
			}
			else*/
		...
		if(blocked)
		{
			...
			getPlayer().sendPacket(new ExMagicAttackInfo(getPlayer().getObjectId(), target.getObjectId(), target.isInvulnerable() ? ExMagicAttackInfo.IMMUNE : ExMagicAttackInfo.BLOCKED)); // TODO: Нужно ли?
		}
	...
	public void sendReuseMessage(Skill skill)
	{
		...
		if(player != null)
		{
			...
			if(hours > 0)
				player.sendPacket(new SystemMessagePacket(SystemMsg.THERE_ARE_S2_HOURS_S3_MINUTES_AND_S4_SECONDS_REMAINING_IN_S1S_REUSE_TIME).addSkillName(skill).addInteger(hours).addInteger(minutes).addInteger(seconds));
			else if(minutes > 0)
				player.sendPacket(new SystemMessagePacket(SystemMsg.THERE_ARE_S2_MINUTES_S3_SECONDS_REMAINING_IN_S1S_REUSE_TIME).addSkillName(skill).addInteger(minutes).addInteger(seconds));
			else
				player.sendPacket(new SystemMessagePacket(SystemMsg.THERE_ARE_S2_SECONDS_REMAINING_IN_S1S_REUSE_TIME).addSkillName(skill).addInteger(seconds));
		}
	}
	...
	public SkillEntry getAdditionalSSEffect(boolean spiritshot, boolean blessed)
	{
		...
		{
			// 紅寶石
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 71372, 0)) // 高級紅寶石 - Lv5
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 17891, 5);
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 71371, 0)) // 高級紅寶石 - Lv4
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 17891, 5);
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 71370, 0)) // 高級紅寶石 - Lv3
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 17891, 4);
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 71369, 0)) // 高級紅寶石 - Lv2
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 17891, 3);
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 71368, 0)) // 高級紅寶石 - Lv1
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 17891, 2);
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 70455, 0)) // 紅寶石 - Lv5
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 17891, 1);
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 70454, 0)) // 紅寶石 - Lv4
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 17890, 1);
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 70769, 0)) // 紅寶石 - Lv4 限時7日
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 17890, 1);
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 70453, 0)) // 紅寶石 - Lv3
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 17889, 1);
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 70452, 0)) // 紅寶石 - Lv2
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 17888, 2);
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 70451, 0)) // 紅寶石 - Lv1
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 17888, 1);
			// 第2組
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 91324, 0)) // 高級紅寶石 - Lv5
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 17891, 5);
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 91431, 0)) // 高級紅寶石 - Lv5 限時30日
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 17891, 5);
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 91323, 0)) // 高級紅寶石 - Lv4
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 17891, 5);
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 91322, 0)) // 高級紅寶石 - Lv3
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 17891, 4);
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 91321, 0)) // 高級紅寶石 - Lv2
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 17891, 3);
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 91320, 0)) // 高級紅寶石 - Lv1
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 17891, 2);
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 90332, 0)) // 紅寶石 - Lv5
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 17891, 1);
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 91418, 0)) // 紅寶石 - Lv5 限時30日
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 17891, 1);
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 90331, 0)) // 紅寶石 - Lv4
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 17890, 1);
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 90330, 0)) // 紅寶石 - Lv3
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 17889, 1);
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 90329, 0)) // 紅寶石 - Lv2
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 17888, 2);
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 90328, 0)) // 紅寶石 - Lv1
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 17888, 1);
		}
		else
		{
			// 藍寶石
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 71377, 0)) // 高級藍寶石 - Lv5
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 39242, 5);
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 71376, 0)) // 高級藍寶石 - Lv4
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 39242, 5);
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 71375, 0)) // 高級藍寶石 - Lv3
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 39242, 4);
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 71374, 0)) // 高級藍寶石 - Lv2
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 39242, 3);
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 71373, 0)) // 高級藍寶石 - Lv1
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 39242, 2);
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 70460, 0)) // 藍寶石 - Lv5
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 39242, 1);
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 70459, 0)) // 藍寶石 - Lv4
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 39241, 1);
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 70770, 0)) // 藍寶石 - Lv4 限時7日
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 39241, 1);
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 70458, 0)) // 藍寶石 - Lv3
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 39240, 1);
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 70457, 0)) // 藍寶石 - Lv2
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 39239, 2);
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 70456, 0)) // 藍寶石 - Lv1
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 39239, 1);
			// 第2組
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 91329, 0)) // 高級藍寶石 - Lv5
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 39242, 5);
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 91432, 0)) // 高級藍寶石 - Lv5 限時30日
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 39242, 5);
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 91328, 0)) // 高級藍寶石 - Lv4
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 39242, 5);
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 91327, 0)) // 高級藍寶石 - Lv3
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 39242, 4);
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 91326, 0)) // 高級藍寶石 - Lv2
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 39242, 3);
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 91325, 0)) // 高級藍寶石 - Lv1
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 39242, 2);
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 90337, 0)) // 藍寶石 - Lv5
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 39242, 1);
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 91419, 0)) // 藍寶石 - Lv5 限時30日
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 39242, 1);
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 90336, 0)) // 藍寶石 - Lv4
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 39241, 1);
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 90335, 0)) // 藍寶石 - Lv3
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 39240, 1);
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 90334, 0)) // 藍寶石 - Lv2
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 39239, 2);
			if(ItemFunctions.checkIsEquipped(getPlayer(), -1, 90333, 0)) // 藍寶石 - Lv1
				return SkillEntry.makeSkillEntry(SkillEntryType.CUNSUMABLE_ITEM, 39239, 1);
		}

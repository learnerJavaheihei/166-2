...
public abstract class Inventory extends ItemContainer
{
	...
	public static final int PAPERDOLL_ARTIFACT_1_1 = 39;
	public static final int PAPERDOLL_ARTIFACT_1_2 = 40;
	public static final int PAPERDOLL_ARTIFACT_1_3 = 41;
	public static final int PAPERDOLL_ARTIFACT_1_4 = 42;
	public static final int PAPERDOLL_ARTIFACT_2_1 = 43;
	public static final int PAPERDOLL_ARTIFACT_2_2 = 44;
	public static final int PAPERDOLL_ARTIFACT_2_3 = 45;
	public static final int PAPERDOLL_ARTIFACT_2_4 = 46;
	public static final int PAPERDOLL_ARTIFACT_3_1 = 47;
	public static final int PAPERDOLL_ARTIFACT_3_2 = 48;
	public static final int PAPERDOLL_ARTIFACT_3_3 = 49;
	public static final int PAPERDOLL_ARTIFACT_3_4 = 50;
	public static final int PAPERDOLL_ARTIFACT_EFFECT_1_1 = 51;
	public static final int PAPERDOLL_ARTIFACT_EFFECT_1_2 = 52;
	public static final int PAPERDOLL_ARTIFACT_EFFECT_1_3 = 53;
	public static final int PAPERDOLL_ARTIFACT_EFFECT_2_1 = 54;
	public static final int PAPERDOLL_ARTIFACT_EFFECT_2_2 = 55;
	public static final int PAPERDOLL_ARTIFACT_EFFECT_2_3 = 56;
	public static final int PAPERDOLL_ARTIFACT_EFFECT_3_1 = 57;
	public static final int PAPERDOLL_ARTIFACT_EFFECT_3_2 = 58;
	public static final int PAPERDOLL_ARTIFACT_EFFECT_3_3 = 59;
	...
	public static final int[] PAPERDOLL_ORDER =
	{
			...
			Inventory.PAPERDOLL_ARTIFACT_1_1,
			Inventory.PAPERDOLL_ARTIFACT_1_2,
			Inventory.PAPERDOLL_ARTIFACT_1_3,
			Inventory.PAPERDOLL_ARTIFACT_1_4,
			Inventory.PAPERDOLL_ARTIFACT_2_1,
			Inventory.PAPERDOLL_ARTIFACT_2_2,
			Inventory.PAPERDOLL_ARTIFACT_2_3,
			Inventory.PAPERDOLL_ARTIFACT_2_4,
			Inventory.PAPERDOLL_ARTIFACT_3_1,
			Inventory.PAPERDOLL_ARTIFACT_3_2,
			Inventory.PAPERDOLL_ARTIFACT_3_3,
			Inventory.PAPERDOLL_ARTIFACT_3_4,
			Inventory.PAPERDOLL_ARTIFACT_EFFECT_1_1,
			Inventory.PAPERDOLL_ARTIFACT_EFFECT_1_2,
			Inventory.PAPERDOLL_ARTIFACT_EFFECT_1_3,
			Inventory.PAPERDOLL_ARTIFACT_EFFECT_2_1,
			Inventory.PAPERDOLL_ARTIFACT_EFFECT_2_2,
			Inventory.PAPERDOLL_ARTIFACT_EFFECT_2_3,
			Inventory.PAPERDOLL_ARTIFACT_EFFECT_3_1,
			Inventory.PAPERDOLL_ARTIFACT_EFFECT_3_2,
			Inventory.PAPERDOLL_ARTIFACT_EFFECT_3_3
	};
	...
	protected boolean onEquip(int slot, ItemInstance item)
	{
		...
		sendEquipInfo(slot);
		sendModifyItem(item);
		/* getActor().getPlayer().recalculateStone();//鑲嵌系統 */
		return true;
	}
	...
	public void equipItem(ItemInstance item)
	{
		...
		else if(bodySlot == ItemTemplate.SLOT_L_BRACELET)
		{
			...
			setPaperdollItem(Inventory.PAPERDOLL_AGATHION_MAIN, null);
			setPaperdollItem(Inventory.PAPERDOLL_AGATHION_1, null);
			setPaperdollItem(Inventory.PAPERDOLL_AGATHION_2, null);
			setPaperdollItem(Inventory.PAPERDOLL_AGATHION_3, null);
			setPaperdollItem(Inventory.PAPERDOLL_AGATHION_4, null);
		}
		else if(bodySlot == ItemTemplate.SLOT_PENDANT)
		...
		{
			if(_paperdoll[PAPERDOLL_AGATHION_MAIN] == null)
				setPaperdollItem(PAPERDOLL_AGATHION_MAIN, item);
			else if(_paperdoll[PAPERDOLL_AGATHION_1] == null)
				setPaperdollItem(PAPERDOLL_AGATHION_1, item);
			else if(_paperdoll[PAPERDOLL_AGATHION_2] == null)
				setPaperdollItem(PAPERDOLL_AGATHION_2, item);
			else if(_paperdoll[PAPERDOLL_AGATHION_3] == null)
				setPaperdollItem(PAPERDOLL_AGATHION_3, item);
			else if(_paperdoll[PAPERDOLL_AGATHION_4] == null)
				setPaperdollItem(PAPERDOLL_AGATHION_4, item);
			else
				setPaperdollItem(PAPERDOLL_AGATHION_MAIN, item);
		}
		else
	...
	public static int[] getPaperdollIndexes(long slot)
	{
		if(slot == ItemTemplate.SLOT_PENDANT)
			return new int[]{ PAPERDOLL_PENDANT };
		...
		if(slot == ItemTemplate.SLOT_JEWEL)
			return new int[]{ PAPERDOLL_JEWEL1, PAPERDOLL_JEWEL2, PAPERDOLL_JEWEL3, PAPERDOLL_JEWEL4, PAPERDOLL_JEWEL5, PAPERDOLL_JEWEL6 };

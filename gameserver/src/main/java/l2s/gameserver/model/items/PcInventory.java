...
import l2s.gameserver.model.items.listeners.AccessorySetListener;//20191223新增的
...
public class PcInventory extends Inventory
{
	...
	public PcInventory(Player owner)
	{
		...
		//20191223新增的
		addListener(AccessorySetListener.getInstance());
	...
	public void startLifeTask(ItemInstance item)
	{

...
public class MultiSellIngredient implements Cloneable
{
	...
	private int _bouns;//multisell支持bouns
	public MultiSellIngredient(int itemId, long itemCount)
	{
		this(itemId, itemCount, 0, -1, -1, 0,0);//multisell支持bouns
	}

	public MultiSellIngredient(int itemId, long itemCount, int chance)
	{
		this(itemId, itemCount, chance, -1, -1, 0,0);//multisell支持bouns
	}

	public MultiSellIngredient(int itemId, long itemCount, int chance, int flags, int durability, int enchant,int bouns)//multisell支持bouns
	{
		_itemId = itemId;
		...
		_bouns = bouns;//multisell支持bouns
	}

	@Override
	public MultiSellIngredient clone()
	{
		MultiSellIngredient mi = new MultiSellIngredient(_itemId, _itemCount, _chance, -1, -1, 0, _bouns);//multisell支持bouns
	...
	public int getBouns()//multisell支持bouns--
	{
		return _bouns;
	}//--multisell支持bouns
	@Override

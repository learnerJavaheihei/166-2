...
public abstract class SiegeEvent<R extends Residence, S extends SiegeClanObject> extends Event
{
	...
	public int getRelation(Player thisPlayer, Player targetPlayer, int result)
	{
		...
		{
			result |= RelationChangedPacket.RELATION_SIEGE_PARTICIPANT;
			...
			if(siegeClan1 == null && siegeClan2 == null || siegeClan1 == siegeClan2 || siegeClan1 != null && siegeClan2 != null && isAttackersInAlly())
				result |= RelationChangedPacket.RELATION_SIEGE_ALLY;
			else
				result |= RelationChangedPacket.RELATION_SIEGE_ENEMY;

			if(siegeClan1 != null)
				result |= RelationChangedPacket.RELATION_SIEGE_ATTACKER;
		}

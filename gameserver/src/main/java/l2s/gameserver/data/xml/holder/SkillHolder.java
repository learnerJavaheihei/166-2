...
import l2s.gameserver.skills.SkillEntry;//怪物取得技能修復於即時地區--
import l2s.gameserver.skills.SkillEntryType;//--怪物取得技能修復於即時地區
...
public final class SkillHolder extends AbstractHolder
{
	...
	public SkillEntry  getSkillEntry(int id, int index)//怪物取得技能修復於即時地區--
	{
		return SkillEntry.makeSkillEntry(SkillEntryType.NONE, getSkillByIndex(id,index));
	}//--怪物取得技能修復於即時地區

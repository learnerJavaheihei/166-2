...
public class SystemMessage extends L2GameServerPacket
{
	...
	public static final int CAN_BE_USED_ONLY_WHEN_HP_IS_LESS_THAN_100 = 3798; // 添加藥水類
	public static final int CAN_BE_USED_ONLY_WHEN_MP_IS_LESS_THAN_100 = 3799; // 添加藥水類
	public static final int CAN_BE_USED_ONLY_WHEN_CP_IS_LESS_THAN_100 = 3800; // 添加藥水類
	public static final int YOU_CANNOT_USE_THE_ITEM_BECAUSE_THE_EFFECT_IS_ALREADY_APPLIED = 3898; // 添加藥水類
	//@Deprecated
	...
	public SystemMessage addSkillName(SkillInfo skillInfo)
	{

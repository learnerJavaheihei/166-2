 ...
 * @author Bonux
**/
public class ExElementalSpiritSetTalent extends L2GameServerPacket
{
	private final boolean _success;
	private final Elemental _elemental;

	public ExElementalSpiritSetTalent(Player player, boolean success, int elementId)
	{
		_success = success;
	...
	protected final void writeImpl()
	{
		...
		if(evolutionLevel > 0)
		{
			...
			writeQ(_elemental.getMinExp()); // Min Exp For Current Level
			writeQ(_elemental.getMaxExp()); // Max Exp For Current Level

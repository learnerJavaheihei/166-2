...
public class DiePacket extends L2GameServerPacket
{
	...
	protected final void writeImpl()
	{
		...
		writeD(_blessingFeatherDelay); // Disables use Feather button for X seconds
		writeD(get(RestartType.ADVENTURES_SONG)); // Adventure's Song
		writeC(_hideDieAnimation ? 0x01 : 0x00); //show die animation

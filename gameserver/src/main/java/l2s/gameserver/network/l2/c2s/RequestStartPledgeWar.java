...
public class RequestStartPledgeWar extends L2GameClientPacket
{
	...
	protected void runImpl()
	{
		...
		{
			activeChar.sendPacket(SystemMsg.A_CLAN_WAR_CAN_ONLY_BE_DECLARED_IF_THE_CLAN_IS_LEVEL_5_OR_ABOVE_AND_THE_NUMBER_OF_CLAN_MEMBERS_IS_FIFTEEN_OR_GREATER);
			activeChar.sendActionFailed();
			return;
		}
		...
		{
			war = new ClanWar(clan, targetClan, ClanWarPeriod.NEW, (int) (System.currentTimeMillis() / 1000L), 0, 0, 0);
			war.start();
		}
	}
}
...
public enum SystemMsg implements IBroadcastPacket
{
	...
	CLAN_S1_HAS_SUCCEEDED_IN_S2(285),
	...
	YOU_ARE_NOT_INVOLVED_IN_A_CLAN_WAR(636),
	...
	// Message: $s1 has declared a Clan War. The war will automatically start if you kill $s1 clan members 5 times within a week.
	S1_HAS_DECLARED_A_CLAN_WAR_THE_WAR_WILL_AUTOMATICALLY_START_IF_YOU_KILL_S1_CLAN_MEMBERS_5_TIMES_WITHIN_A_WEEK(1561),
	// Message: You have declared a Clan War with $s1.
	YOU_HAVE_DECLARED_A_CLAN_WAR_WITH_S1(1562),
	// Message: A clan war can only be declared if the clan is level 5 or above, and the number of clan members is fifteen or greater.
	...
	// Message: This instant zone will be terminated in $s1 minute(s). You will be forced out of the dungeon when the time expires.
	...
	// Message: You cannot declare defeat as it has not been 7 days since starting a clan war with Clan $s1.
	YOU_CANNOT_DECLARE_DEFEAT_AS_IT_HAS_NOT_BEEN_7_DAYS_SINCE_STARTING_A_CLAN_WAR_WITH_CLAN_S1(3283),
	// Message: The war ended by your Defeat Declaration with the $s1 clan.
	THE_WAR_ENDED_BY_YOUR_DEFEAT_DECLARATION_WITH_THE_S1_CLAN(3284),
	// Message: The war ended by the $s1 clan's Defeat Declaration. You have won the Clan War over the $s1 clan.
	THE_WAR_ENDED_BY_THE_S1_CLANS_DEFEAT_DECLARATION_YOU_HAVE_WON_THE_CLAN_WAR_OVER_THE_S1_CLAN(3285),
	// Message: You can't declare a war because the 21-day-period hasn't passed after a Defeat Declaration with the $s1 clan.
	YOU_CANT_DECLARE_A_WAR_BECAUSE_THE_21DAYPERIOD_HASNT_PASSED_AFTER_A_DEFEAT_DECLARATION_WITH_THE_S1_CLAN(3286),
	// Message: This account has already received a gift. The gift can only be given once per account.
	THIS_ACCOUNT_HAS_ALREADY_RECEIVED_A_GIFT_THE_GIFT_CAN_ONLY_BE_GIVEN_ONCE_PER_ACCOUNT(3289),
	...
	THE_ITEM_THAT_IS_CURRENTLY_WORN_CANNOT_BE_REGISTERED(3494),//multisell支持enchant
	...
	CAN_BE_USED_ONLY_WHEN_HP_IS_LESS_THAN_100(3798),//添加藥水類
	CAN_BE_USED_ONLY_WHEN_MP_IS_LESS_THAN_100(3799),//添加藥水類
	CAN_BE_USED_ONLY_WHEN_CP_IS_LESS_THAN_100(3800),//添加藥水類
	YOU_CANNOT_USE_THE_ITEM_BECAUSE_THE_EFFECT_IS_ALREADY_APPLIED(3898),//添加使用藥水類
	// Message: Because $c1 was killed by a clan member of $s2, Clan Reputation decreased by 1.
	BECAUSE_C1_WAS_KILLED_BY_A_CLAN_MEMBER_OF_S2_CLAN_REPUTATION_DECREASED_BY_1(3811),
	// Message: Because a clan member of $s1 was killed by $c2, Clan Reputation increased by 1.
	BECAUSE_A_CLAN_MEMBER_OF_S1_WAS_KILLED_BY_C2_CLAN_REPUTATION_INCREASED_BY_1(3812),
	// Message: Because Clan $s1 did not fight back for 1 week, the clan war was cancelled.
	BECAUSE_CLAN_S1_DID_NOT_FIGHT_BACK_FOR_1_WEEK_THE_CLAN_WAR_WAS_CANCELLED(3813),
	...
	YOU_ARE_NOT_IN_A_CLAN(4202),
	// Message: Sayune cannot be used while taking other actions.
	SAYUNE_CANNOT_BE_USED_WHILE_TAKING_OTHER_ACTIONS(4205),
	...
	THIS_ITEM_DOES_NOT_EXIST(4222),
	// Message: You cannot equip $s1 without equipping a brooch.
	YOU_CANNOT_EQUIP_S1_WITHOUT_EQUIPPING_A_BROOCH(4237),
	...
	// Message: You cannot use or reset Ability Points while participating in the Olympiad or Ceremony of Chaos.
	YOU_CANNOT_USE_OR_RESET_ABILITY_POINTS_WHILE_PARTICIPATING_IN_THE_OLYMPIAD_OR_CEREMONY_OF_CHAOS(4296),
	...
	// Message: You can redeem your reward $s1 minutes after logging in. $s2 minutes left.
	YOU_CAN_REDEEM_YOUR_REWARD_S1_MINUTES_AFTER_LOGGING_IN_S2_MINUTES_LEFT(4321),
	// Message: You can redeem your reward now.
	YOU_CAN_REDEEM_YOUR_REWARD_NOW(4322),
	// Message: The trade was successful.
	THE_TRADE_WAS_SUCCESSFUL(4358),
	// Message: Cannot show because the conditions are not met.
	CANNOT_SHOW_BECAUSE_THE_CONDITIONS_ARE_NOT_MET(4361),
	// Message: You cannot join a clan while you are in the Training Camp.
	YOU_CANNOT_JOIN_A_CLAN_WHILE_YOU_ARE_IN_THE_TRAINING_CAMP(4371),
	// Message: Cannot enter; some users may not yet be seated.
	CANNOT_ENTER_SOME_USERS_MAY_NOT_YET_BE_SEATED(4393),
	// Message: Only Level 3-4 Clans can be registered in a Castle Siege
	ONLY_LEVEL_34_CLANS_CAN_BE_REGISTERED_IN_A_CASTLE_SIEGE(4397),
	THE_ITEM_WAS_UPGRADED_YOU_OBTAINED_S1(4471),//升級系統--
	C1_HAS_SUCCEEDED_IN_UPGRADING_EQUIPMENT_AND_OBTAINED_A_S2(4472),
	FAILED_THE_OPERATION(4473),
	FAILED_BECAUSE_THE_TARGET_ITEM_DOES_NOT_EXIST(4474),
	FAILED_BECAUSE_THERE_ARE_NOT_ENOUGH_INGREDIENTS(4475),
	FAILED_BECAUSE_THERES_NOT_ENOUGH_ADENA(4476),//--升級系統
	// Message: You cannot use the Agathion's power because you are not wearing the left bracelet.
	YOU_CANNOT_USE_THE_AGATHIONS_POWER_BECAUSE_YOU_ARE_NOT_WEARING_THE_LEFT_BRACELET(4527),
	// Message: <$s1> will be your attribute attack from now on.
	S1_WILL_BE_YOUR_ATTRIBUTE_ATTACK_FROM_NOW_ON(5107),
	// Message: Reset the selected Spirit's Characteristics successfully.
	RESET_THE_SELECTED_SPIRITS_CHARACTERISTICS_SUCCESSFULLY(5118),
	// Message: Not enough <Adena> to proceed with reset.
	NOT_ENOUGH_ADENA_TO_PROCEED_WITH_RESET(5152),
	// Message: Your edits will not be saved if you change Spirits.
	YOUR_EDITS_WILL_NOT_BE_SAVED_IF_YOU_CHANGE_SPIRITS(5160),
	// Message: Use Attribute Attack of <$s1>.
	USE_ATTRIBUTE_ATTACK_OF_S1(5161),
	// Message: Unable to extract during battle.
	UNABLE_TO_EXTRACT_DURING_BATTLE(5162),
	// Message: Unable to extract because Inventory is full.
	UNABLE_TO_EXTRACT_BECAUSE_INVENTORY_IS_FULL(5163),
	// Message: Unable to evolve during battle.
	UNABLE_TO_EVOLVE_DURING_BATTLE(5164),
	// Message: This Spirit cannot evolve.
	THIS_SPIRIT_CANNOT_EVOLVE(5165),
	// Message: Spirit of other Attribute does not fit the evolution condition.
	SPIRIT_OF_OTHER_ATTRIBUTE_DOES_NOT_FIT_THE_EVOLUTION_CONDITION(5166),
	// Message: Unable to absorb during battle.
	UNABLE_TO_ABSORB_DURING_BATTLE(5167),
	// Message: Unable to reset Spirit Attribute during battle.
	UNABLE_TO_RESET_SPIRIT_ATTRIBUTE_DURING_BATTLE(5168),
	// Message: Unable to open Attribute after the third class change.
	UNABLE_TO_OPEN_ATTRIBUTE_AFTER_THE_THIRD_CLASS_CHANGE(5169),
	// Message: Obtained $s2 Attribute XP of $s1.
	OBTAINED_S2_ATTRIBUTE_XP_OF_S1(5170),
	// Message: $s1 Attribute Spirit became level $s2.
	S1_ATTRIBUTE_SPIRIT_BECAME_LEVEL_S2(5171),
	// Message: Unable to use $s1 because Attribute is not learnt.
	UNABLE_TO_USE_S1_BECAUSE_ATTRIBUTE_IS_NOT_LEARNT(5172),
	// Message: Not enough Attribute XP for extraction.
	NOT_ENOUGH_ATTRIBUTE_XP_FOR_EXTRACTION(5173),
	// Message: $s1 Attack Critical is activated.
	S1_ATTACK_CRITICAL_IS_ACTIVATED(5174),
	// Message: Attack Attribute can be changed after $s1 seconds.
	ATTACK_ATTRIBUTE_CAN_BE_CHANGED_AFTER_S1_SECONDS(5175),
	// Message: $s1 has delivered $s3 (Attribute Damage: $s4) to $s2.
	S1_HAS_DELIVERED_S3_ATTRIBUTE_DAMAGE_S4_TO_S2(5176),
	// Message: $s1 has received $s3 (Attribute Damage: $s4) from $s2.
	S1_HAS_RECEIVED_S3_ATTRIBUTE_DAMAGE_S4_FROM_S2(5177),
	// Message: $s1 has delivered $s3 (Attribute Damage: $s5) to $s2, $s4 damage to the damage transference target.
	S1_HAS_DELIVERED_S3_ATTRIBUTE_DAMAGE_S5_TO_S2_S4_DAMAGE_TO_THE_DAMAGE_TRANSFERENCE_TARGET(5178),
	// Message: You have obtained an Attribute. Open your Character Information Screen to check. 
	YOU_HAVE_OBTAINED_AN_ATTRIBUTE_OPEN_YOUR_CHARACTER_INFORMATION_SCREEN_TO_CHECK_(5181),
	...
	// Message: You have completed training in the Royal Training Camp, and obtained $s1 XP and $s2 SP.
	...
	// Message: You cannot receive rewards for training if you have trained for less than 1 minute.
	YOU_CANNOT_RECEIVE_REWARDS_FOR_TRAINING_IF_YOU_HAVE_TRAINED_FOR_LESS_THAN_1_MINUTE(6154),
	// Message: You cannot take other action while entering the Training Camp.
	YOU_CANNOT_TAKE_OTHER_ACTION_WHILE_ENTERING_THE_TRAINING_CAMP(6156),
	// Message: You cannot request to a character who is entering the Training Camp.
	...
	// Message: Calculating XP and SP obtained from training…
	CALCULATING_XP_AND_SP_OBTAINED_FROM_TRAINING(6161),
	// Message: $c1 is currently in the Royal Training Camp, and cannot participate in the Olympiad.
	C1_IS_CURRENTLY_IN_THE_ROYAL_TRAINING_CAMP_AND_CANNOT_PARTICIPATE_IN_THE_OLYMPIAD(6162),
	// Message: You can only be rewarded as the class in which you entered the training camp.
	YOU_CAN_ONLY_BE_REWARDED_AS_THE_CLASS_IN_WHICH_YOU_ENTERED_THE_TRAINING_CAMP(6163),
	// Message: Only one character per account may enter at any time.
	ONLY_ONE_CHARACTER_PER_ACCOUNT_MAY_ENTER_AT_ANY_TIME(6166),
	// Message: You cannot enter the training camp while in a party or using the automatic replacement system.
	YOU_CANNOT_ENTER_THE_TRAINING_CAMP_WHILE_IN_A_PARTY_OR_USING_THE_AUTOMATIC_REPLACEMENT_SYSTEM(6167),
	// Message: You cannot enter the training camp with a mount or in a transformed state.
	YOU_CANNOT_ENTER_THE_TRAINING_CAMP_WITH_A_MOUNT_OR_IN_A_TRANSFORMED_STATE(6168),
	// Message: You have completed the day's training.
	YOU_HAVE_COMPLETED_THE_DAYS_TRAINING(6169),
	// Message: Lv. $s1 or above
	LV_S1_OR_ABOVE(6170),
	// Message: Lv. $s1 or below
	LV_S1_OR_BELOW(6171),
	...
	// Message: Your clan has achieved login bonus Lv. $s1.
	YOUR_CLAN_HAS_ACHIEVED_LOGIN_BONUS_LV_S1(6826),
	// Message: Your clan has achieved hunting bonus Lv. $s1.
